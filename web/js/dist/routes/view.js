...
/******/ 	return __webpack_require__(__webpack_require__.s = "./web/js/app/routes/view.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"View\", function() { return View; });\n/* harmony import */ var _ConfirmModalDialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ConfirmModalDialog */ \"./web/js/app/components/ConfirmModalDialog.js\");\n/* harmony import */ var _VisualComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./VisualComponent */ \"./web/js/app/components/VisualComponent.js\");\n/* harmony import */ var _listing_Listing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listing/Listing */ \"./web/js/app/components/listing/Listing.js\");\n\n\n\n\nclass View extends _VisualComponent__WEBPACK_IMPORTED_MODULE_1__[\"VisualComponent\"]\n{\n    constructor(container)\n    {\n        super(container);\n\n        this.elements.formPopup = _listing_Listing__WEBPACK_IMPORTED_MODULE_2__[\"Listing\"].getFormPopup();\n        this.confirmDialogTemplate = $('.js-template-confirm-modal-dialog').html();\n    }\n\n    /**\n     * @param {String} [deleteButtonClass='.js-delete']\n     */\n    initDeleteEvent(deleteButtonClass)\n    {\n        let self = this;\n        deleteButtonClass = deleteButtonClass || '.js-delete';\n\n        this.container.on('click', deleteButtonClass, function (e) {\n            let link = $(this),\n                message = link.data('message'),\n                title = link.data('title'),\n                url = link.data('url') || link.closest('a').attr('href');\n\n            e.preventDefault();\n\n            new _ConfirmModalDialog__WEBPACK_IMPORTED_MODULE_0__[\"ConfirmModalDialog\"]({\n                template: self.confirmDialogTemplate,\n                data: {\n                    '{title}': title,\n                    '{message}': message,\n                },\n                button: {\n                    'confirm': function () { window.location.replace(url) },\n                }\n            });\n        });\n    }\n}\n\n\n\n//# sourceURL=webpack:///./web/js/app/components/View.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_View__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/View */ \"./web/js/app/components/View.js\");\n\n\n$(function() {\n    let view = new _components_View__WEBPACK_IMPORTED_MODULE_0__[\"View\"]($('.js-view'));\n    view.initDeleteEvent();\n});\n\n//# sourceURL=webpack:///./web/js/app/routes/view.js?");
