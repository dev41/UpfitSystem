...
/******/ 	return __webpack_require__(__webpack_require__.s = "./web/js/app/routes/notification.index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./web/js/app/components/listing/NotificationListing.js":
/*!**************************************************************!*\
  !*** ./web/js/app/components/listing/NotificationListing.js ***!
  \**************************************************************/
/*! exports provided: NotificationListing */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"NotificationListing\", function() { return NotificationListing; });\n/* harmony import */ var _Listing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Listing */ \"./web/js/app/components/listing/Listing.js\");\n\n\nconst selector = {\n    BUTTON_DELETE: '.js-delete-notification',\n    BUTTON_SET_STATUS: '.js-set-status',\n};\n\nclass NotificationListing extends _Listing__WEBPACK_IMPORTED_MODULE_0__[\"Listing\"]\n{\n    constructor(container)\n    {\n        super(container);\n        this.initEvents();\n    }\n\n    initEvents()\n    {\n        let self = this;\n\n        this.initDeleteEvent(selector.BUTTON_DELETE);\n\n        this.container.on('click', selector.BUTTON_SET_STATUS, function(e) {\n            let icon = $(this),\n                url = icon.data('url');\n\n            e.preventDefault();\n\n            self.lock();\n            $.ajax({\n                type: 'post',\n                url: url\n            }).done(function (response) {\n                if (!response.success) {\n                    return;\n                }\n\n                icon.toggleClass('fa-envelope-o fa-envelope text-yellow');\n            }).always(function () {\n                self.unlock();\n            });\n        });\n    }\n}\n\n\n\n//# sourceURL=webpack:///./web/js/app/components/listing/NotificationListing.js?");
...
/***/ "./web/js/app/routes/notification.index.js":
/*!*************************************************!*\
  !*** ./web/js/app/routes/notification.index.js ***!
  \*************************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_listing_NotificationListing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/listing/NotificationListing */ \"./web/js/app/components/listing/NotificationListing.js\");\n\n\n$(function() {\n    new _components_listing_NotificationListing__WEBPACK_IMPORTED_MODULE_0__[\"NotificationListing\"]($('.js-notification-container'));\n});\n\n//# sourceURL=webpack:///./web/js/app/routes/notification.index.js?");
